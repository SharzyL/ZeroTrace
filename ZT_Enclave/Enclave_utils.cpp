...
void oarray_search(uint32_t *array, uint32_t loc, uint32_t *leaf,
...
void serializeECCKeys(sgx_ec256_private_t *ZT_private_key,
                      sgx_ec256_public_t *ZT_public_key,
                      unsigned char *serialized_keys) {
...
void SerializeBNPair(BIGNUM *x, BIGNUM *y, unsigned char **bin_x,
                     unsigned char **bin_y) {
