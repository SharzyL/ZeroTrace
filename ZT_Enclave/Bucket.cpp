...
Bucket::Bucket(unsigned char *serialized_bucket, uint32_t data_size,
               uint8_t param_Z) {
...
Bucket::Bucket(uint8_t param_Z) { Z = param_Z; }
...
void Bucket::serializeToBuffer(unsigned char *serializeBuffer,
                               uint32_t data_size) {
...
void Bucket::fill(unsigned char *serialized_block, uint32_t pos,
